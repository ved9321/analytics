  ...
  return (
    <div className="flex flex-col items-center px-5 pb-5">
      <svg width={size} height={size} viewBox="0 0 42 42" role="img" aria-label={totalLabel}>
        <circle cx="21" cy="21" r={radius} fill="none" stroke="#F0EEEA" strokeWidth="5.5" />
        ...
        <text x="21" y="20.4" textAnchor="middle" fontSize="5.2" fontWeight="650" fill="#12100E">
          {format(sum)}
        </text>
        <text x="21" y="24.8" textAnchor="middle" fontSize="2.5" fill="#9C9890" letterSpacing=".12">
          {totalLabel}
        </text>
      </svg>
